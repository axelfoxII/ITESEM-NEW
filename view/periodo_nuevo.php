												...
												<div class="rel-wrapper ui-datepicker ui-datepicker-popup dp-theme-primary" id="example-datepicker-container-5">
													<div class="input-daterange" id="example-datepicker-5">
														<div class="form-group row">
															<div class="col-6">
																<p>FECHA DE INICIO</p>
																<input class="form-control" type="text" name="fecha_inicio" value="" placeholder="DD-MM-YYYY" autocomplete="off" required="">
															</div>
															<div class="col-6">
																<p>FECHA DE FIN</p>
																<input class="form-control" type="text" name="fecha_fin" value="" placeholder="DD-MM-YYYY" autocomplete="off" required="">
															</div>
														</div>
													</div>
												</div>
