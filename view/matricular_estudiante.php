					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								<center><h2>Matricular Estudiantes</h2></center>
								<br>
								<div class="row">
								...
								<div class="no-more-tables">
									<table id="datatable_buscador" class="table table-striped table-sm">
										...
										<tbody>
											...
											$item = 1;
											$sql_estudiante = mysqli_query($con, "SELECT cod_estudiante, nombre_per, apellido_per, carnet_per, nombre_car, sigla_suc, 
												resolucion_ministerial_car, nombre_tipest 
												...
												AND cod_tipoestudiante_est = cod_tipoestudiante AND cod_sucursal_est = $cod_suc ORDER BY cod_estudiante DESC LIMIT 0, 10");
											...
											<tr>
												...
												<td data-title="MODIFICAR" align="center"><a href="matricular_estudiante_detalle.php?cod=<?php echo $row_e['cod_estudiante']; ?>">Detalle</a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
			...
			$(document).ready(function(){
				...
				$("#buscar_carnet").keyup(function(e){
					if($(this).val().length > 2){
						...
						$.ajax({
							type: "POST",
							url: "../class/buscar_matricular.php",
