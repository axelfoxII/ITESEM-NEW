									...
									<fieldset>
										<div class="form-group row">
											...
											<div class="col-sm-5">
												...
												<input class="form-control" type="text" name="nit" placeholder="..." required="">
											</div>
										</div>
									</fieldset>
									<fieldset>
										<div class="form-group row">
											<div class="col-sm-5">
												...
												<input class="form-control" type="text" name="telefono" placeholder="..." required="">
											</div>
											<div class="col-sm-7">
												<label class="col-form-label">DIRECCION</label>
												<input class="form-control" type="text" name="direccion" placeholder="..." required="">
											</div>
										</div>
									</fieldset>
									<fieldset>
										<div class="form-group row">
											<div class="col-sm-6">
												...
												<input class="form-control" type="text" name="municipio" placeholder="..." required="">
											</div>
											<div class="col-sm-4">
											...
											<div class="col-sm-2">
												...
												<input class="form-control" type="text" name="codigo_siat" placeholder="..." required="">
											</div>
										</div>
									</fieldset>
