					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								<?php
								if(isset($_POST['menu']) && isset($_POST['icono'])){
									$menu = strtoupper(preg_replace('/[^a-zA-ZáéíóúñÁÉÍÓÚÑ\s]/iu', '', $_POST['menu']));
									$icono = $_POST['icono'];

									if($_POST['tipo'] == "guardar"){
										// INSERT tbl_menu
										$insert_carrera = mysqli_query($con, "INSERT INTO tbl_menu(nombre_menu, icono_menu) 
											VALUES('$menu', '$icono')");
										...
										// UPDATE tbl_menu
										$update_menu = mysqli_query($con, "UPDATE tbl_menu SET nombre_menu = '$menu', icono_menu = '$icono' 
