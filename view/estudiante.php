					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								...
								<a href="estudiante_nuevo.php" class="btn btn-labeled btn-primary" type="button"><span class="btn-label"><i class="ion-plus-round"></i></span>Nuevo Registro</a>
								<div class="row">
			...
			$(document).ready(function(){
				...
				$("#buscar_carnet").keyup(function(e){
					if($(this).val().length > 2){
						...
						$.ajax({
							type: "POST",
							url: "../class/buscar_estudiante.php",
