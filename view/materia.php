					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								...
								<a href="materia_nuevo.php" class="btn btn-labeled btn-primary" type="button"><span class="btn-label"><i class="ion-plus-round"></i></span>Nuevo Registro</a>
								<br><br>
								<div class="table-responsive">
									<table class="table table-striped my-4" id="datatable1">
										...
										<tbody>
											<?php
											$item = 1;
											$sql_materia = mysqli_query($con, "SELECT cod_materia, nombre_mat, sigla_mat, nombre_estmat, sigla_car, nombre_car, resolucion_ministerial_car, estado_mat 
												FROM tbl_materia, tbl_carrera, tbl_estructura_materia WHERE cod_estructura_materia = cod_estructura_materia_mat AND cod_carrera = cod_carrera_mat 
												ORDER BY cod_materia DESC");
											...
											<tr>
												...
												<td data-title="ESTRUCTURA"><?php echo $row_m['nombre_estmat']; ?></td>
												<td data-title="CARRERA"><?php echo $row_m['sigla_car']." - <small>".$row_m['resolucion_ministerial_car']."</small>"; ?></td>
												<td data-title="MODIFICAR" align="center"><a href="materia_modificar.php?cod=<?php echo $row_m['cod_materia']; ?>">Modificar</a></td>
												<td data-title="ELIMINAR" align="center"><a href="fun-del/materia_delete.php?cod=<?php echo $row_m['cod_materia']; ?>" onclick="return confirm('¿Estás seguro de cambiar este registro?')"><?php echo $det_estado; ?></a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
