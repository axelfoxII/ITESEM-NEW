					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								<center><h2 class="text-primary">Historico de Notas</h2></center>
								<div class="row">
								...
								<div class="no-more-tables">
									<table id="datatable_buscador" class="table table-striped table-sm">
										...
										<tbody>
											...
											$item = 1;
											$sql_estudiante = mysqli_query($con, "SELECT cod_estudiante, nombre_per, apellido_per, carnet_per, complemento_carnet_per, nombre_car, 
												resolucion_ministerial_car
												FROM tbl_estudiante, tbl_persona, tbl_carrera 
												WHERE cod_persona_est = cod_persona AND cod_carrera_est = cod_carrera AND estado_est = 1 AND cod_sucursal_est = $cod_suc 
												ORDER BY cod_estudiante DESC LIMIT 0, 10");
											...
											<tr>
												...
												<td data-title="CARRERA"><?php echo $row_e['nombre_car']." - <small>".$row_e['resolucion_ministerial_car']."</small>"; ?></td>
			...
			$(document).ready(function(){
				...
				$("#buscar_carnet").keyup(function(e){
					if($(this).val().length > 2){
						...
						$.ajax({
							type: "POST",
							url: "../class/buscar_historico.php",
