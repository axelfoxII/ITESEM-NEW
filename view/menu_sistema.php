					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								...
								<a href="menu_sistema_nuevo.php" class="btn btn-labeled btn-primary" type="button"><span class="btn-label"><i class="ion-plus-round"></i></span>Nuevo Registro</a>
								<br><br>
								<div class="table-responsive">
									<table class="table table-striped my-4" id="datatable1">
										...
										<tbody>
											<?php
											$item = 1;
											$sql_menu = mysqli_query($con, "SELECT * FROM tbl_menu ORDER BY nombre_menu");
											while ($row_m = mysqli_fetch_array($sql_menu)) {
												$det_estado = "<div class='text-primary'>HABILITADO</div>";
												if($row_m['estado_menu'] == 0)
													$det_estado = "<div class='text-danger'>INHABILITADO</div>";
											?>
											<tr>
												<td data-title="#"><?php echo $item++; ?></td>
												<td data-title="MENÚ"><?php echo $row_m['nombre_menu']; ?></td>
												<td data-title="MODIFICAR" align="center"><a href="menu_sistema_modificar.php?cod=<?php echo $row_m['cod_menu']; ?>">Modificar</a></td>
												<td data-title="ELIMINAR" align="center"><a href="fun-del/menu_sistema_delete.php?cod=<?php echo $row_m['cod_menu']; ?>" onclick="return confirm('¿Estás seguro de cambiar este registro?')"><?php echo $det_estado; ?></a></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
