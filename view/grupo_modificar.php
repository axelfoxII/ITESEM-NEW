						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									$cod_nivel = 0; $cod_turno = 0;
									$nombre = "";
									$sql_grupo = mysqli_query($con, "SELECT * FROM tbl_grupo WHERE cod_grupo = $cod_grupo");
									while ($row_p = mysqli_fetch_array($sql_grupo)) {
										$cod_nivel = $row_p['cod_nivel_gru'];
										$cod_turno = $row_p['cod_turno_gru'];
										$nombre = $row_p['nombre_gru'];
									}
								}
								?>
