						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_menu
									$estado_subm = 0;
									$sql_submenu = mysqli_query($con, "SELECT estado_subm FROM tbl_submenu WHERE cod_submenu = $cod_submenu");
									while ($row_s = mysqli_fetch_array($sql_submenu)) {
										if($row_s['estado_subm'] == 0)
											$estado_subm = 1;
									}
									// UPDATE tbl_menu
									$update_submenu = mysqli_query($con, "UPDATE tbl_submenu SET estado_subm = $estado_subm 
