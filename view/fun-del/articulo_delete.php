						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_articulo
									$estado_art = 0;
									$sql_articulo = mysqli_query($con, "SELECT estado_art FROM tbl_articulo WHERE cod_articulo = $cod_articulo");
									while ($row_a = mysqli_fetch_array($sql_articulo)) {
										if($row_a['estado_art'] == 0)
											$estado_art = 1;
									}
									// UPDATE tbl_articulo
									$update_carrera = mysqli_query($con, "UPDATE tbl_articulo SET estado_art = $estado_art 
