						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_sucursal
									$estado_suc = 0;
									$sql_sucursal = mysqli_query($con, "SELECT estado_suc FROM tbl_sucursal WHERE cod_sucursal = $cod_sucursal");
									while ($row_s = mysqli_fetch_array($sql_sucursal)) {
										if($row_s['estado_suc'] == 0)
											$estado_suc = 1;
									}
									// UPDATE tbl_sucursal
									$update_sucursal = mysqli_query($con, "UPDATE tbl_sucursal SET estado_suc = $estado_suc 
								...
								?>
								<div class="text-center">
									<a href="../sucursal.php">Volver al Inicio</a>
								</div>
