						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_docente
									$estado_doc = 0;
									$sql_docente = mysqli_query($con, "SELECT estado_doc FROM tbl_docente WHERE cod_docente = $cod_docente");
									while ($row_d = mysqli_fetch_array($sql_docente)) {
										if($row_d['estado_doc'] == 0)
											$estado_doc = 1;
									}
									// UPDATE tbl_docente
									$update_carrera = mysqli_query($con, "UPDATE tbl_docente SET estado_doc = $estado_doc 
