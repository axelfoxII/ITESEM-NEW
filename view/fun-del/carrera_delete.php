						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_carrera
									$estado_car = 0;
									$sql_carrera = mysqli_query($con, "SELECT estado_car FROM tbl_carrera WHERE cod_carrera = $cod_carrera");
									while ($row_c = mysqli_fetch_array($sql_carrera)) {
										if($row_c['estado_car'] == 0)
											$estado_car = 1;
									}
									// UPDATE tbl_carrera
									$update_carrera = mysqli_query($con, "UPDATE tbl_carrera SET estado_car = $estado_car 
