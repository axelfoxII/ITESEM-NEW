						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_grupo
									$estado_gru = 0;
									$sql_grupo = mysqli_query($con, "SELECT estado_gru FROM tbl_grupo WHERE cod_grupo = $cod_grupo");
									while ($row_g = mysqli_fetch_array($sql_grupo)) {
										if($row_g['estado_gru'] == 0)
											$estado_gru = 1;
									}
									// UPDATE tbl_carrera
									$update_grupo = mysqli_query($con, "UPDATE tbl_grupo SET estado_gru = $estado_gru WHERE cod_grupo = $cod_grupo");
