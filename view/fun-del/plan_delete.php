						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_plan
									$estado_plan = 0;
									$sql_plan = mysqli_query($con, "SELECT estado_plan FROM tbl_plan WHERE cod_plan = $cod_plan");
									while ($row_p = mysqli_fetch_array($sql_plan)) {
										if($row_p['estado_plan'] == 0)
											$estado_plan = 1;
									}
									// UPDATE tbl_plan
									$update_plan = mysqli_query($con, "UPDATE tbl_plan SET estado_plan = $estado_plan 
