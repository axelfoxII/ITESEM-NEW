						...
						<div class="cardbox">
							<div class="cardbox-body">
								...
								if(isset($_GET['cod'])){
									...
									// SELECT tbl_carrera
									$estado_us = 0;
									$sql_carrera = mysqli_query($con, "SELECT estado_us FROM tbl_usuario WHERE cod_usuario = $cod_usuario");
									while ($row_c = mysqli_fetch_array($sql_carrera)) {
										if($row_c['estado_us'] == 0)
											$estado_us = 1;
									}
									// UPDATE tbl_carrera
									$update_carrera = mysqli_query($con, "UPDATE tbl_usuario SET estado_us = $estado_us 
