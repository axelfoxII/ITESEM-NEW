									...
									<fieldset>
										<div class="form-group row">
											<div class="col-sm-2">
												...
												<input class="form-control" type="text" name="precio" placeholder="... 0.00" required="" onKeyPress="return numeros(event)">
											</div>
											<div class="col-sm-2">
												<label class="col-form-label">PRECIO TOTAL/AÑO</label>
												<input class="form-control" type="text" name="precio_total" placeholder="... 0.00" required="" onKeyPress="return numeros(event)">
											</div>
											<div class="col-sm-5">
