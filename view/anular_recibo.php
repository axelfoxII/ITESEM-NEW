					...
					<div class="container-fluid">
						<div class="cardbox">
							<div class="cardbox-body">
								<center><h2>Anular Recibo</h2></center>
								<div class="row">
                      ...
                      <input class="form-control" id="example-datepicker-4" type="text" data-date="" placeholder="...Fecha">
								...
								while($row_s = mysqli_fetch_array($sql_suc)){
									$cod_sucursal = $row_s['cod_sucursal'];
								}
								?>
									...
									<table class="table table-striped table-bordered table-sm">
										...
										<tbody id="datatable_buscador">
											...
											$sql = mysqli_query($con, "SELECT cod_venta, monto_total_venta, nombre_per, apellido_per, carnet_per, fecha_venta, estado_venta FROM tbl_venta, tbl_estudiante, tbl_persona 
												WHERE cod_estudiante_venta = cod_estudiante AND cod_persona_est = cod_persona AND cod_sucursal_est = $cod_sucursal ORDER BY cod_venta DESC LIMIT 0,10");
											if(mysqli_num_rows($sql) > 0){
												...
												?>
												<tr>
													<td colspan="7" align="center">No hay resultados en la tabla.</td>
												</tr>
												<?php
											}
											?>
			...
			$(document).ready(function(){
				...
				$("#buscar_nro_recibo").keyup(function(e){
					if($(this).val() !== ""){
						...
						$.ajax({
							type: "POST",
							url: "../class/buscar_anular_ingresos.php",
