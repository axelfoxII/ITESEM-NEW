...
(function (jsPDF) {
	...
	var themes = {
	    ...
	    'grid': {
	        table: { fillColor: 255, textColor: 80, fontStyle: 'normal', lineWidth: 0.3, fillStyle: 'DF' },
	        header: { textColor: 80, fillColor: [255, 255, 255], rowHeight: 23, lineWidth: 0.3, fillStyle: 'DF', fontStyle: 'bold' },
	        body: {  },
			bodyStyles: {lineColor: [225, 225, 225], fontStyle: 'normal'},
	        alternateRow: {}
	    },
	    'plain': {
		...
		// 'GRIB' color medio celeste ----> fillColor: [26, 188, 156]
	};
